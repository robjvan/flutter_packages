...
### [Firebase Image Provider](https://pub.dev/packages/firebase_image)
...
### [Google Place](https://pub.dev/packages/google_place)

A Flutter plugin for iOS and Android and Web that provides a Google Place API.

### [Flutter Google Places](https://pub.dev/packages/flutter_google_places)
...
### [Shine](https://pub.dev/packages/flutter_shine)
...
### [Glassmorphic Container](https://pub.dev/packages/glassmorphism)
...
### [Neumorphic](https://pub.dev/packages/neumorphic)

Neumorphic Ui kit for flutter

### [Flutter Neumorphic](https://pub.dev/packages/flutter_neumorphic_null_safety)

A complete, ready to use, Neumorphic ui kit for Flutter

### [Flutter Acrylic](https://pub.dev/packages/flutter_acrylic)
...
<!-- <img src='https://user-images.githubusercontent.com/16286046/110208631-aabb8480-7e88-11eb-8a92-4e77636965ce.gif'> -->
...
### [OctoImage](https://pub.dev/packages/octo_image)
...
### [SyncFucion Flutter Charts](https://pub.dev/packages/syncfusion_flutter_charts)
...
### [SyncFusion Flutter DatePicker](https://pub.dev/packages/syncfusion_flutter_datepicker)
...
<!-- <img src='https://github.com/sarbagyastha/flutter_rating_bar/raw/master/flutter_rating_bar.gif'> -->
...
<!-- <img src='https://github.com/marcos930807/awesomeDialogs/raw/master/doc/gif.gif'> -->
...
### [Flutter Fluid Slider](https://pub.dev/packages/flutter_fluid_slider)

A fluid design slider that works just like the Slider material widget.

### [Progress Dialog](https://pub.dev/packages/progress_dialog)
...
### [Flutter Info Slider](https://pub.dev/packages/intro_slider)
...
### [Flutter WeChat Assets Picker](https://pub.dev/packages/wechat_assets_picker)
...
### [Flutter NFC Reader](https://pub.dev/packages/flutter_nfc_reader)
